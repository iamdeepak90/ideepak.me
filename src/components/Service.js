                ...
                data.map(
                  (data, i) =>
                    data && (
                      ...
                      >
                        <div className="list_inner tilt-effect" style={{ background: `linear-gradient(rgb(255, 255, 255), rgba(255, 255, 255, 0.9)), url(${data.icon}) no-repeat 130% 360% / 50% rgb(255, 255, 255)` }}>
                          <span className="icon">
                            <img
                              src={data.icon}
                              alt="image"
